...
namespace AreaConversionTests {
	TEST_CLASS(MetricSystemConversion) {
		...
		TEST_METHOD(AreaConverter_Convert10SquareKilometerToSquareMeters_Returns10000000) {
			AreaConverter ac;
			double input = 10;
		...
		TEST_METHOD(AreaConverter_Convert10000000SquareMetersToSquareKilometers_Returns10) {
			AreaConverter ac;
	...
	TEST_CLASS(OldRussianConversionTests) {
		...
		TEST_METHOD(AreaConverter_Convert10SquareArshinToSquareMeters_Returns5p058) {
			AreaConverter ac;
			double input = 10;
			double target = 5.058;
			AreaType type = AreaType::square_arshin;
	...
	TEST_CLASS(USAConversionTests) {
		...
		TEST_METHOD(AreaConverter_Convert10SquareMileToSquareMeters_Returns25900000) {
			AreaConverter ac;
			double input = 10;
			double target = 25900000;
			AreaType type = AreaType::square_mile;
			double conversion_result = ac.toSquareMeters(type, input);
			std::wstring msg = (
				L"Conversion result of " + std::to_wstring(input)
		...
		TEST_METHOD(AreaConverter_Convert25900000SquareMetersToSquareMiles_Returns10) {
			AreaConverter ac;
			double input = 2590000;
			double target = 1;
			AreaType type = AreaType::square_mile;
